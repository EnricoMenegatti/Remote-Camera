...
void setup() 
{
  ...
  startWiFi(); // Start a Wi-Fi access point, and try to connect to some given accesspoints. Then wait for either an AP or STA connection
...
void startWiFi() // Start a Wi-Fi access point, and try to connect to some given access points. Then wait for either an AP or STA connection
{
  ...
  //wifiMulti.addAP("VodafoneMobileWiFi-45A1D6", "W1VDP90067"); // add Wi-Fi networks you want to connect to
